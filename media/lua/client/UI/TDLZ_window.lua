...
function TodoListZManagerUI:create()
    ...
    self.customButton = ISButton:new(self.copyButton:getRight(), 25, 25, 25, getText("UI_KRFM_Custom"), self, self.onCustomAdd);
    ...
    if player then
        ...
        if modData.todoListMod == nil or reset == true then
            modData.todoListMod = {
                isFirstRun = true,
                storedChannels = {},
                panelSettings = { x = 70, y = 400, width = 400, height = 300, pin=false };
            }
        end
